...
if uploaded_file:
    ...
    entities_cash = xls.parse("Entities & Cash", skiprows=4).dropna(subset=["Unnamed: 1"])
    ...
    max_sources = st.sidebar.slider("Max number of sources", 1, len(cash_df)+len(ico_df), 5)
